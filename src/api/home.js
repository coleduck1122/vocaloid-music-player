...
// 获取推荐歌单
export const personalized = () => request('/personalized', 'get')

// 获取每日推荐歌单
export const recommendSongList = () => request('/recommend/resource', 'get')

// 获取每日推荐歌曲
export const recommendSong = () => request('/recommend/songs', 'get')
